...
/*   Updated: 2022/12/24 20:57:43 by yamzil           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	writing_pxl_to_img2(t_map *list, int x, int y, t_data *data)
{
	...
	color = 0;
	// if ((int)(data->arr[data->ti].yofset * data->arr[data->ti].width + data->arr[data->ti].xofset)> 1048576)
	// 	printf("%d\n",(int)(data->arr[data->ti].yofset * data->arr[data->ti].width + data->arr[data->ti].xofset));
