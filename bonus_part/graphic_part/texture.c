...
void	loading_textures(t_data *data)
{
	...
	data->arr[DOORS].img = mlx_xpm_file_to_image(data->mlx, "texture/door.xpm", &data->arr[DOORS].width,&data->arr[DOORS].height);
	...
	data->arr[DOORS].addr = (int *)mlx_get_data_addr(data->arr[DOORS].img, &data->arr[DOORS].bits,&data->arr[DOORS].size,&data->arr[DOORS].end);
}
